function score = scoringFunction02(values)

   
   % this version is the same as the previous version with the following
   % exceptions:
   % * It continues to run the simulation 10 seconds after the balance
   % point is found
   % TODO: * It reruns a simulation two more times if it was successful.  

   
   maxMotor = 8;   %TODO: put in an appropriate value 
